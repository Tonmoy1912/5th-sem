...
class Sender(Thread):
    ...
    def run(self):
        ...
        while curr_frame < frames_len:
            ...
            #continuous sensing of channel for transmission
            can_use = False
            while True:
                sem.acquire()
                if(isBusy==False):
...
print(f"Total bits send {total_bits}")
throughput=total_bits/duration
print(f"Throughput={throughput} bits/s")
